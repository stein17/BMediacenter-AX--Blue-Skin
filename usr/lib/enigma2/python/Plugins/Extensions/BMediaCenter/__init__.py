...
config.plugins.mc_vlc.vcodec = ConfigSelection({'mp1v': 'MPEG1',
 'mp2v': 'MPEG2'}, 'mp2v')
config.plugins.mc_vlc.vb = ConfigInteger(1000, (100, 9999))
config.plugins.mc_vlc.acodec = ConfigSelection({'mpga': 'MP1',
 'mp2a': 'MP2',
 'mp3': 'MP3'}, 'mp2a')
config.plugins.mc_vlc.ab = ConfigInteger(128, (64, 320))
config.plugins.mc_vlc.samplerate = ConfigSelection({'0': 'as Input',
 '44100': '44100',
 '48000': '48000'}, '0')

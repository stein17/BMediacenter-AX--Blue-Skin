...
loadSkin('/usr/lib/enigma2/python/Plugins/Extensions/BMediaCenter/skins/defaultHD/skinFHD.xml')
try:
...
class DMC_MainMenu(Screen):
    ...
    def __init__(self, session):
        ...
        list.append((_('My Pictures'),
         ...
         'menu_pictures',
         '50'))
        list.append((_('Web Radio'),
         'MC_WebRadio',
         'menu_radio',
         '50'))
        list.append((_('VLC Player'),
         'MC_VLCPlayer',
         'menu_vlc',
         '50'))
        list.append((_('Weather Info'),
         'MC_WeatherInfo',
         'menu_weather',
         '50'))
...
def Plugins(**kwargs):
    if config.plugins.mc_globalsettings.showinmainmenu.value == True and config.plugins.mc_globalsettings.showinextmenu.value == True:
        return [PluginDescriptor(name='Media Center', description='Media Center Plugin for your STB_BOX', icon='plugin.png', where=PluginDescriptor.WHERE_PLUGINMENU, fnc=main), PluginDescriptor(name='Media Center', description='Media Center Plugin for your STB_BOX', where=PluginDescriptor.WHERE_MENU, fnc=menu), PluginDescriptor(name='Media Center', description='Media Center Plugin for your STB_BOX', icon='plugin.png', where=PluginDescriptor.WHERE_EXTENSIONSMENU, fnc=main)]
        ...
        return [PluginDescriptor(name='Media Center', description='Media Center Plugin for your STB_BOX', icon='plugin.png', where=PluginDescriptor.WHERE_PLUGINMENU, fnc=main), PluginDescriptor(name='Media Center', description='Media Center Plugin for your STB_BOX', where=PluginDescriptor.WHERE_MENU, fnc=menu)]
        ...
        return [PluginDescriptor(name='Media Center', description='Media Center Plugin for your STB_BOX', icon='plugin.png', where=PluginDescriptor.WHERE_PLUGINMENU, fnc=main)]